...
@Component({
  ...
  <footer class="w-full py-12 text-center text-slate-800 text-xs border-t border-slate-900 uppercase tracking-widest font-mono">
  The Word // Digital Reflection // 2026
  </footer>
  </div>
  `,
})
